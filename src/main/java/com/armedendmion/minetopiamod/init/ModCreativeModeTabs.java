    ...
    public static final RegistryObject<CreativeModeTab> MINETOPIA_FOOD = CREATIVE_MODE_TABS.register("minetopia_food",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.HOTDOG.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.CAN_LENTILES_SOUP.get());
                        pOutput.accept(ModItems.PEPPERNUT.get());
                        pOutput.accept(ModItems.CHOCOLATE_EGG.get());
                        pOutput.accept(ModItems.CHOCOLATES.get());
                        pOutput.accept(ModItems.FRIES_MAYONNAISE.get());
                        pOutput.accept(ModItems.CHOCOLATE_ICECREAM.get());
                        pOutput.accept(ModItems.CHOCOLATE_KIDS_ICECREAM.get());
                        pOutput.accept(ModItems.KIDS_ICECREAM.get());
                        pOutput.accept(ModItems.DEEP_FRIED_DOUGHNUT_BALLS.get());
                        pOutput.accept(ModItems.DEEP_FRIED_RAISIN_BUN.get());
                        pOutput.accept(ModItems.SMURFS_ICECREAM.get());
                        pOutput.accept(ModItems.VANILLA_ICECREAM.get());
                        pOutput.accept(ModItems.FLEMISH_FRIES.get());
                        pOutput.accept(ModItems.AVOCADO.get());
                        pOutput.accept(ModItems.BROWNIE.get());
                        pOutput.accept(ModItems.DONER_SANDWICH.get());
                        pOutput.accept(ModItems.HEALTHY_SANDWICH.get());
                        pOutput.accept(ModItems.SAUSAGE_ROLL.get());
                        pOutput.accept(ModItems.WIENER_SCHNITZEL.get());
                        pOutput.accept(ModItems.CROISSANT.get());
                        pOutput.accept(ModItems.DATES.get());
                        pOutput.accept(ModItems.HERRING.get());
                        pOutput.accept(ModItems.CHEESE_FONDUE.get());
                        pOutput.accept(ModItems.CARP.get());
                        pOutput.accept(ModItems.CHRISTMAS_COOKIE.get());
                        pOutput.accept(ModItems.CHICKEN_NUGGETS.get());
                        pOutput.accept(ModItems.LOBSTER.get());
                        pOutput.accept(ModItems.RED_LOLLYPOP.get());
                        pOutput.accept(ModItems.LOLLYPOP.get());
                        pOutput.accept(ModItems.LIEGE_WAFFLE.get());
                        pOutput.accept(ModItems.MUSSELS.get());
                        pOutput.accept(ModItems.OYSTER.get());
                        pOutput.accept(ModItems.OYSTERS.get());
                        pOutput.accept(ModItems.PRETZEL.get());
                        pOutput.accept(ModItems.REDFISH.get());
                        pOutput.accept(ModItems.PIKE.get());
                        pOutput.accept(ModItems.SPARERIBS.get());
                        pOutput.accept(ModItems.COOKED_SPARERIBS.get());
                        pOutput.accept(ModItems.STURGEON.get());
                        pOutput.accept(ModItems.STROOPWAFEL.get());
                        pOutput.accept(ModItems.TURKISH_PIZZA.get());
                        pOutput.accept(ModItems.WAFFLE.get());
                        pOutput.accept(ModItems.SALTY_FISH.get());
                        pOutput.accept(ModItems.FRIED_FISH.get());
                        pOutput.accept(ModItems.OMELET.get());
                        pOutput.accept(ModItems.MEATBALLS.get());
                        pOutput.accept(ModItems.LASAGNE.get());
                        pOutput.accept(ModItems.POPCORN.get());
                        pOutput.accept(ModItems.SPAGHETTI.get());
                        pOutput.accept(ModItems.WRAP.get());
                        pOutput.accept(ModItems.LEMON.get());
                        pOutput.accept(ModItems.KIWI.get());
                        pOutput.accept(ModItems.FRIKANDELBROODJE.get());
                        pOutput.accept(ModItems.DROP.get());
                        pOutput.accept(ModItems.CANDY_GREEN.get());
                        pOutput.accept(ModItems.CANDY_PURPLE.get());
                        pOutput.accept(ModItems.CANDY_RED.get());
                        ...
                        pOutput.accept(ModItems.TOMATO_SOUP.get());
                        pOutput.accept(ModItems.ROOKWORST.get());
                        pOutput.accept(ModItems.CHEESECAKE.get());
                        pOutput.accept(ModItems.BOSSCHE_BOL.get());
                        pOutput.accept(ModItems.CHOCOLATE_CAKE.get());
                        pOutput.accept(ModItems.VANILLA_CAKE.get());
                        pOutput.accept(ModItems.SHRIMP.get());
                        pOutput.accept(ModItems.COOKED_SHRIMP.get());
                        pOutput.accept(ModItems.MERINGUE.get());
                        pOutput.accept(ModItems.TAAITAAI.get());
                        pOutput.accept(ModItems.SPICED_BESQUIT.get());
                        pOutput.accept(ModItems.TOMPOUCE.get());
                        ...
                        pOutput.accept(ModItems.BEER_BOTTLE.get());
                        pOutput.accept(ModItems.BEER_GLASS.get());
                        pOutput.accept(ModItems.MILKSHAKE.get());
                        pOutput.accept(ModItems.ALCOHOL_BOTTLE.get());
                        pOutput.accept(ModItems.ORANGE_JUICE.get());
                        pOutput.accept(ModItems.VITAMINE_A.get());
                        pOutput.accept(ModItems.VITAMINE_B.get());
                        pOutput.accept(ModItems.VITAMINE_C.get());
                        pOutput.accept(ModItems.VITAMINE_D.get());
                        pOutput.accept(ModItems.VITAMINE_E.get());
                        pOutput.accept(ModItems.VITAMINE_F.get());
                        pOutput.accept(ModItems.DOG_FOOD.get());
                        pOutput.accept(ModItems.CAT_FOOD.get());
