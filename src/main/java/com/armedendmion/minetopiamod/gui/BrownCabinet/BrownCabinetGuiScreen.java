...
public class BrownCabinetGuiScreen extends AbstractContainerScreen<BrownCabinetGuiMenu> {
	private final static HashMap<String, Object> guistate = BrownCabinetGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public BrownCabinetGuiScreen(BrownCabinetGuiMenu container, Inventory inventory, Component text) {
