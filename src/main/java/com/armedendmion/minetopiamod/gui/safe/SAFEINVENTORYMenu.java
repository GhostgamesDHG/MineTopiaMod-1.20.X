...
public class SAFEINVENTORYMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SAFEINVENTORYMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ModMenu.SAFEINVENTORY.get(), id);
		...
		for (int si = 0; si < 3; ++si)
			for (int sj = 0; sj < 9; ++sj)
				this.addSlot(new Slot(inv, sj + (si + 1) * 9, 8 + sj * 18, -15 + 84 + si * 18));
		for (int si = 0; si < 9; ++si)
			this.addSlot(new Slot(inv, si, 8 + si * 18, -15 + 142));
	}
