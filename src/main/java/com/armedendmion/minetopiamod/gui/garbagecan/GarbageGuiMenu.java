...
public class GarbageGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GarbageGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ModMenu.GARBAGE_GUI.get(), id);
